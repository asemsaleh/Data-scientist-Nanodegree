...
def load_data(messages_filepath, categories_filepath):
    '''read messages.csv, read categories and convert it, then merge them 
        Input: file path of messages, categories
        Output: returns merged data frame of messages and categories
        This function read messages, process categories using defined function, merge both of them
    '''
...
def save_data(df, database_filename):
    '''
    Input: df:dataframe,database_filename: name of stored database
    Output:stores the dataframe into sqlite database
